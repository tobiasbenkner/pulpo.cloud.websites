...
export const translations = {
  ...
  content: {
    ...
    h1: { es: "1. Datos Identificativos", de: "1. Identifikationsdaten", en: "1. Identification Data" },
    p1: {
    ...
    h3: { es: "3. Propiedad Intelectual", de: "3. Geistiges Eigentum", en: "3. Intellectual Property" },
    p3: {
    ...
    h4: { es: "4. Exclusión de Garantías", de: "4. Haftungsausschluss", en: "4. Exclusion of Guarantees" },
    p4: {
